...
import { AddTraineeshipComponent } from './Traineeship/add-traineeship/add-traineeship.component';
import { TraineeshipTableComponent } from './Traineeship/traineeship-table/traineeship-table.component';
import { FormsModule, ReactiveFormsModule } from '@angular/forms';
import { HttpClientModule } from '@angular/common/http';
import { AddFileComponent } from './file/add-file/add-file.component';
import { FileTableComponent } from './file/file-table/file-table.component';
import { TraineeshipsPageComponent } from './Traineeship/traineeships-page/traineeships-page.component';
...
@NgModule({
  declarations: [
    ...
    BlogTwoComponent,
    AddTraineeshipComponent,
    TraineeshipTableComponent,
    AddFileComponent,
    FileTableComponent,
    TraineeshipsPageComponent,
  ],
  imports: [
    CommonModule,
    RouterModule,
    MatTabsModule,
    SwiperModule,FormsModule,ReactiveFormsModule,HttpClientModule
  ],
